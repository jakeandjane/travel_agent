...
class TripRequest(BaseModel):
    ...
    user_id: Optional[str] = Field(default=None, description="用户ID，用于偏好记忆")
...
class Attraction(BaseModel):
    ...
    time_start: Optional[str] = Field(default=None, description="开始时间 HH:MM")
...
class Meal(BaseModel):
    ...
    time_start: Optional[str] = Field(default=None, description="用餐时间 HH:MM")
...
class TripPlanResponse(BaseModel):
    ...
    plan_id: Optional[str] = Field(default=None, description="计划ID，用于后续微调")
...
class PlanHistoryResponse(BaseModel):
    """计划历史列表响应"""
    success: bool = Field(..., description="是否成功")
    plans: List[PlanSummary] = Field(default=[], description="历史计划列表")
...
class RefineRequest(BaseModel):
    """计划微调请求"""
    plan_id: str = Field(..., description="要修改的计划ID")
    message: str = Field(..., description="用户的修改请求（自然语言）")
...
class RefineResponse(BaseModel):
    """计划微调响应"""
    success: bool = Field(..., description="是否成功")
    reply: str = Field(default="", description="AI的回复")
    changes: List[str] = Field(default=[], description="具体修改列表")
    modified_plan: Optional[TripPlan] = Field(default=None, description="修改后的完整计划")
